...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_n7uouh4', 'template_6byk69o', form.current, {
        publicKey: '-LwV52HNFPm0N3d3O',
      })
     e.target.reset()
  };
  return (
            ...
            <div className="contact_content">
                ...
                <div className="contact_info">
                    <div className="contact_card">
                        ...
                        <a href="mailto:examplemail.gmail.com" className='contact_button'>Write me <i className="uil uil-arrow-right contact_button-icon"></i></a>
                    </div>
                     <div className="contact_card">
                      <i className="bx bxl-whatsapp contact_card_icon"></i>
                        ...
                        <a href="https://api.whatsapp.com/send?phone=62214408789&text=Hello, more information!" className='contact_button'>Write me <i className="uil uil-arrow-right contact_button-icon"></i></a>
                    </div>
                     <div className="contact_card">
                        ...
                        <a href="https://m.me/crypticalcoder" className='contact_button'>Write me <i className="uil uil-arrow-right contact_button-icon"></i></a>
                    </div>
                </div>
            </div>
             <div className="contact_content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact_form">
                    <div className="contact_form-div">
                     ...
                     <div className="contact_form-div contact_form-div    ">
