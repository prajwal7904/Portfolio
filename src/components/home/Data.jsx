...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className="home_title">Prajwal K
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home_description">
            Enthusiastic and dedicated MEARN Stack Developer with hands-on experience in building full‑stack web
            applications using MongoDB, Express.js, Angular, React, and Node.js. Passionate about creating efficient,
            scalable, and user‑friendly applications. Seeking to leverage technical skills and project experience to
            contribute to innovative development projects in a dynamic organization.
        </p>
