            ...
            <div className="services_content">
                ...
                <div className={toggleState===1?"services_modal active-modal":"services_modal"}>
                    <div className="services-modal-content">
                        ...
                        <p className="services_modal-description">Services with more than 1 years of experience.Providing quality work to clients as a freelancer services</p>
                        <ul className="services_modal-services grid">
                            ...
                            <li className="services-modal services">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">Design and mockup for product for companies</p>
                            </li>
                        </ul>
                    </div>
                </div>
